...
public class SettingsController {
    ...
    @ResponseBody
    public ResponseEntity addTad(@CurrentUser Account account, @RequestBody TagForm tagForm) {
    ...
    @ResponseBody
    public ResponseEntity removeTad(@CurrentUser Account account, @RequestBody TagForm tagForm) {
        String title = tagForm.getTagTitle();
        Tag tag = tagRepository.findByTitle(title);
        if (tag == null){
